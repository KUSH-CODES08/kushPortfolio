...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Resume", href: "/Kush-CV.pdf", external: true },
  ];

  const scrollToSection = (e, href) => {
    // Allow external links and PDF files to open normally
    if (!href.startsWith("#")) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white dark:bg-gray-800 shadow-lg rounded-b-xl">
