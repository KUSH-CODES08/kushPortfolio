      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 inline-block">
            <div className="relative w-44 h-44 rounded-full p-[4px] bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 shadow-[0_0_30px_rgba(59,130,246,0.4)]">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto animate-slide-up">
            I build data-driven web applications, backend systems, and AI
            automation using Python. Passionate about creating scalable
