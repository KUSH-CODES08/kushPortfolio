...
const Hero = () => {
  ...
  const roles = ['Python Developer', 'Backend Engineer', 'AI Enthusiast', 'Problem Solver'];
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-4 animate-fade-in">
            Hi, I'm <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Kush Bhavsar</span>
          </h1>
          ...
          <div className="h-16 md:h-20 flex items-center justify-center mb-6">
            <h2 className="text-2xl md:text-4xl font-semibold text-gray-700 dark:text-gray-300">
              <span className="text-blue-600 dark:text-purple-400">{text}</span>
              <span className="animate-pulse">|</span>
            </h2>
          </div>

          {/* Tagline */}
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto animate-slide-up">
            I build data-driven web applications, backend systems, and AI automation using Python. 
          ...
          <div className="mt-12 flex justify-center space-x-6">
            <a
              ...
              className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-purple-400 transition-all transform hover:scale-110"
              aria-label="GitHub"
            >
            ...
            <a
              href="https://linkedin.com/in/bhavsar-kush-ba73b0271/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-purple-400 transition-all transform hover:scale-110"
              aria-label="LinkedIn"
