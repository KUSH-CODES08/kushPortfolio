...
const Projects = () => {
  ...
  return (
    <section id="projects" className="section-container gradient-bg">
      <div className="max-w-7xl mx-auto">
        <SectionTitle
          title="Featured Projects"
          subtitle="Here are some of my recent projects showcasing my skills and creativity"
        />
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, i) => (
                      <span
                        key={i}
                        className="px-3 py-1 bg-blue-100 dark:bg-gray-700 text-blue-600 dark:text-blue-400 rounded-full text-xs font-medium"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex gap-3 pt-4">
                  <a
                    ...
                    className="flex-1 px-4 py-2 bg-gray-900 dark:bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors text-center text-sm"
                  >
                    <svg
